...
class Event(eventName: String, eventCourse: Course, eventDate: String, eventCreated : String, eventNote: String) : Serializable{
    ...
    override fun toString(): String {
        return "Event(eventId=$eventId, eventName='$eventName', eventCreated='$eventCreated', eventOrganiser='$eventOrganiser', eventCourse='$eventCourse', eventDate='$eventDate', eventNote='$eventNote',  eventStatus='$eventStatus')"
    }
}